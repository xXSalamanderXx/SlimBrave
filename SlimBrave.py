...
tk.Label(top_frame, text="Quick Toggles:", font=("sans-serif", 12, "bold"), fg="#87CEFA", bg="#191919").pack(side="left", padx=(100, 10))
...
btn_priv = tk.Button(top_frame, text="High Privacy + Moderate Security", bg="#3c3c3c", fg="white", highlightbackground="#191919", command=lambda: apply_preset("privacy"))
...
btn_sec = tk.Button(top_frame, text="High Security + Moderate Privacy", bg="#3c3c3c", fg="white", highlightbackground="#191919", command=lambda: apply_preset("security"))
